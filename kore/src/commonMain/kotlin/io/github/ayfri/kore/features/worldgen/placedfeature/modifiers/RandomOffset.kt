...
data class RandomOffset(
	var xzSpread: IntProvider = ConstantIntProvider(0),
	var ySpread: IntProvider = ConstantIntProvider(0),
) : PlacementModifier(), IntProviderScope

fun PlacedFeature.randomOffset(xzSpread: IntProvider = ConstantIntProvider(0), ySpread: IntProvider = ConstantIntProvider(0)) {
