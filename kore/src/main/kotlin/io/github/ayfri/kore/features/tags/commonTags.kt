...
fun DataPack.functionTag(
	fileName: String = "io/github/ayfri/kore/functions/ayfri/kore/functions",
	namespace: String = name,
	replace: Boolean = false,
	block: Tag<FunctionTagArgument>.() -> Unit = {},
) = tag(fileName, "io/github/ayfri/kore/functions/ayfri/kore/functions", namespace, replace, block)
