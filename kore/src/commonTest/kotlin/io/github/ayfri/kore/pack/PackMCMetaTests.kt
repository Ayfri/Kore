...
private fun testEmptyDatapackMCMeta() = dataPack("empty_pack") {
	pretty()
...
private fun testPackMCMetaMinMaxFormat() = dataPack("minmax_pack") {
	pretty()
	pack {
...
private fun testPackMCMetaNoExtraFields() = dataPack("no_extra_pack") {
	pretty()
	pack {
...
@Suppress("DEPRECATION")
private fun testPackMCMetaWithFeatures() = dataPack("features_pack") {
	pretty()
	pack {
...
@Suppress("DEPRECATION")
private fun testPackMCMetaWithFilter() = dataPack("filter_pack") {
	pretty()
	pack {
...
@Suppress("DEPRECATION")
private fun testPackMCMetaWithOverlays() = dataPack("overlays_pack") {
	pretty()
	pack {
