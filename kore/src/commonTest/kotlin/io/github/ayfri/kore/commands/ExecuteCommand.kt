...
fun Function.executeTests() {
	...
	fun ifScoreRelation(relation: String) =
		"if score $selectorAsString $scoreName $relation $selectorAsString $scoreName"
	...
	execute {
		...
		execute ${ifScoreMatches("..0")} ${ifScoreMatches("..1")} ${ifScoreMatches("1")} ${ifScoreMatches("1..")} ${
		ifScoreMatches(
			"2.."
		)
	}
		${ifScoreRelation("<")} ${ifScoreRelation("<=")} ${ifScoreRelation("=")} ${ifScoreRelation(">=")} ${
		ifScoreRelation(
			">"
		)
	}
