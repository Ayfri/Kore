...
fun Function.scoreboardTests() {
	scoreboard {
		objectives {
			...
			add(
				"test",
				criteriaCrafted(Items.STONE)
			) assertsIs "scoreboard objectives add test minecraft.crafted:minecraft.stone"
			add(
				"test",
				criteriaCustom(CustomStats.JUMP)
			) assertsIs "scoreboard objectives add test minecraft.custom:minecraft.jump"
			...
			modifyNumberFormatFixed(
				"test",
				textComponent("test")
			) assertsIs "scoreboard objectives modify test numberformat fixed \"test\""
			modifyNumberFormatFixed(
				"test",
				"test",
				color = Color.RED
		...
		players {
			...
			displayName(
				...
				"test",
				textComponent("test")
			) assertsIs "scoreboard players display name @s test \"test\""
			...
			operation(
				...
				self(),
				"test"
			) assertsIs "scoreboard players operation @s test += @s test"
