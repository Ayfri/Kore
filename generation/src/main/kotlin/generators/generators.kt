	...
	val txtListsTreeGenerators = listOf(
		...
		gen("Tags", "tags") {
			...
			tagsParents(
				...
				"worldgen/density_function" to "worldgen.DensityFunctionTag",
				"worldgen/flat_level_generator_preset" to "worldgen.FlatLevelGeneratorPresetTag",
				"worldgen/noise" to "worldgen.NoiseTag",
				"worldgen/noise_settings" to "worldgen.NoiseSettingsTag",
				"worldgen/placed_feature" to "worldgen.PlacedFeatureTag",
				"worldgen/processor_list" to "worldgen.ProcessorListTag",
				"worldgen/structure" to "worldgen.ConfiguredStructureTag",
				"worldgen/structure_set" to "worldgen.StructureSetTag",
				"worldgen/template_pool" to "worldgen.TemplatePoolTag",
