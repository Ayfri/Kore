...
/**
 * OOP entity handle targeting a specific spawned text display entity by UUID.
 *
 ...
 */
class TextDisplayEntity(val uuid: UUIDArgument) : Entity() {
	override val type = EntityTypes.TEXT_DISPLAY

	init {
		selector.type = EntityTypes.TEXT_DISPLAY
