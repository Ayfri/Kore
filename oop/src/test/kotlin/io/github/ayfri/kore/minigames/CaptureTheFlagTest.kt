...
fun captureTheFlagTest() = testDataPack("ctf") {
	...
	function("start_round") {
		...
		guardSpawner.spawn() assertsIs "summon minecraft:iron_golem 50.0 64.0 50.0"
	...
	function("end_round") {
		...
		attacker.teleportTo(
			...
			64,
			0
		) assertsIs "teleport @e[limit=1,name=Attacker,team=blue,type=minecraft:player] 0.0 64.0 0.0"
		defender.teleportTo(
			0,
			64,
			0
		) assertsIs "teleport @e[limit=1,name=Defender,team=red,type=minecraft:player] 0.0 64.0 0.0"
