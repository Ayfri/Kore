...
fun Function.itemTests() {
	items {
		...
		modify(self(), WEAPON, Argument.ItemModifier("baz")) assertsIs "item modify entity @s weapon minecraft:baz"
	...
	itemSlot(self(), WEAPON) {
		modify(Argument.ItemModifier("baz")) assertsIs "item modify entity @s weapon minecraft:baz"
