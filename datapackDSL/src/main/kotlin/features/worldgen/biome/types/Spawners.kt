...
@Serializable
data class Spawn(
	var type: Argument.EntitySummon,
	var weight: Int = 1,
	var minCount: Int = 0,
	var maxCount: Int = 0,
)
...
fun MutableList<Spawn>.spawner(type: Argument.EntitySummon, weight: Int, minCount: Int = 0, maxCount: Int = 0) {
	add(Spawn(type, weight, minCount, maxCount))
}

fun MutableList<Spawn>.spawner(type: Argument.EntitySummon, init: Spawn.() -> Unit = {}) {
