...
class Schedule(private val fn: Function) {
	...
	fun append(function: Argument.Function, time: TimeNumber) = fn.addLine(command("schedule", literal("function"), function, time(time), literal("append")))
	...
	fun replace(function: Argument.Function, time: TimeNumber) = fn.addLine(command("schedule", literal("function"), function, time(time), literal("replace")))
}
