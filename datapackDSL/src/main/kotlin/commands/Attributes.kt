...
class AttributeTarget(private val fn: Function, private val target: Argument.Selector) {
	fun get(attribute: arguments.enums.Attribute) = Attribute(fn, target, attribute(attribute))
}

class Attributes(private val fn: Function) {
	fun get(target: Argument.Selector, attribute: arguments.enums.Attribute) = Attribute(fn, target, attribute(attribute))
...
fun Function.attributes(target: Argument.Selector, attribute: arguments.enums.Attribute, block: Attribute.() -> Unit) = Attribute(this, target, attribute(attribute)).run(block)
